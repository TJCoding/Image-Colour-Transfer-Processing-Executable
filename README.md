...
The processing provides for the re-colouring of one image with the colours of another image.  The image to be re-coloured is known as the ‘target image’ and the image that provides the colours is known as the ‘palette image’.  This processing is illustrated by the following examples.
