...
Different images may be processed by renaming them as "'target.jpg" and "palette.jpg" and overwriting the existing files.
...
There is no issue here.  Microsoft is being over cautious for software which does not originate from a certified software company. 
